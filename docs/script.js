...
//
// на событие ввода (input) будет вызываться функцией validateEmail
...
function validateEmail(){
    ...
    if(emailRegex.test(emailInput.value)) // проверяем совпадение с регулярным выражением
    {
        hideError(emailInput); // уюираем ошибку
        return true;
    }
    else //не совпадает 
    {
